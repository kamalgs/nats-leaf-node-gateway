//! High-performance NATS protocol parser.
//!
...
//!
//! The outgoing message builder ([`MsgBuilder`]) lives in
//! [`crate::protocol::msg_builder`] and is re-exported here for convenience.
